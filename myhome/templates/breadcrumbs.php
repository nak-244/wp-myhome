...
if ( $myhome_breadcrumbs && $myhome_breadcrumbs->has_elements() ) :
	?>
	<div
	...
	>
		<div class="mh-layout">
			<div class="mh-breadcrumbs">
				...
				<?php if ( $myhome_breadcrumbs->has_child() && ( $myhome_child_attribute = $myhome_breadcrumbs->get_child_attribute() ) !== false ) : ?>
					<div class="mh-breadcrumbs__item-wrapper">
						<div class="mh-breadcrumbs__item">
							...
							>
								<option
									...
									value="placeholder"
								>
									<?php echo esc_html( $myhome_child_attribute->get_name() ); ?>
								</option>
