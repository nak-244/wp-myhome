...
if ( ! class_exists( 'My_Home_Layout' ) ) :
	...
	class My_Home_Layout {
		 ...
		 * @return bool
		 */
		public function favorite_enabled() {
			$enabled = My_Home_Theme()->settings->get( 'favorite' );
		 ...
		 * @return bool
		 */
		public function save_search_enabled() {
			$enabled = My_Home_Theme()->settings->get( 'save_search' );
		 ...
		 * @return bool
		 */
		public function show_agents_on_agency_page() {
			$show = My_Home_Theme()->settings->get( 'agent_show-agents' );
