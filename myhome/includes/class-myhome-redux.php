	...
	class My_Home_Redux {
		...
		public function set_design_options_menu() {
			...
			$args  = Array(
				...
				'display_name'        => esc_html__( 'MyHome Design', 'myhome' ),
				'display_version'     => $theme->get( 'Version' ),
				'menu_type'           => 'menu',
				'allow_sub_menu'      => true,
			...
			$section = array(
				...
				'fields'     => array(
					...
					array(
						...
						'subtitle' => esc_html__( 'Menu logo will be displayed only on the mobile. This option can be useful if you have logo in the top bar, but you do not want to display top bar on the mobile.', 'myhome' )
					),
					...
					array(
						...
						'subtitle' => esc_html__( 'Default: 10', 'myhome' ) . '<br>' . esc_html__( 'You can also use negative values e.g. -5.', 'myhome' )
					),
			...
			$section = array(
				...
				'fields'     => array(
					...
					array(
						...
						'subtitle' => esc_html__( 'When user delete property using frontend panel, property can be permanently deleted or trashed', 'myhome' ),
						'type'     => 'select',
						'default'  => 'trash',
						'options'  => array(
...
//					),
				...
				'fields'     => array(
					...
					array(
						...
						'subtitle' => '<a target="_blank" href="https://myhometheme.zendesk.com/hc/en-us/articles/360003770253#facebook">' .
						              esc_html__( 'Click here to read how to configure Facebook Social Login', 'myhome' ) . '</a><br><br>' .
					...
					array(
						...
						'subtitle' => '<a target="_blank" href="https://myhometheme.zendesk.com/hc/en-us/articles/360003770253#twitter">' .
						              esc_html__( 'Click here to read how to configure Twitter Social Login', 'myhome' ) . '</a><br><br>' .
					...
					array(
						...
						'subtitle' => '<a target="_blank" href="https://myhometheme.zendesk.com/hc/en-us/articles/360003770253#google">' .
						              esc_html__( 'Click here to read how to configure Google Social Login', 'myhome' ) . '</a><br><br>' .
					...
					array(
						...
						'subtitle' => '<a target="_blank" href="https://myhometheme.zendesk.com/hc/en-us/articles/360003770253#linkedin">' .
						              esc_html__( 'Click here to read how to configure Linkedin Social Login', 'myhome' ) . '</a><br><br>' .
			...
			$section = array(
				...
				'desc'       => esc_html__( 'Front-end panel must be enabled to run Google reCAPTCHA (MyHome Theme > Users > General > "Enable Frontend user panel")', 'myhome' ),
			...
			$section = array(
				...
				'fields'     => array(
					...
					array(
						...
						'title'    => esc_html__( 'Number of properties that new registered user can add for free', 'myhome' ),
						'type'     => 'text',
						'default'  => 0,
						'required' => array(
							array( 'mh-payment', '=', true ),
					...
					array(
						...
						'title'    => esc_html__( 'Number of featured properties that new registered user can add for free', 'myhome' ),
						'type'     => 'text',
						'default'  => 0,
						'required' => array(
							array( 'mh-payment', '=', true ),
			...
			$section = array(
				...
				'fields'     => array(
					...
					array(
						...
						'default'  => esc_html__( 'Dear {{username}},', 'myhome' ) . '<br><br>' . esc_html__( '{{agency_name}} invites you to join their agency account. You can accept/decline invitation in your user panel {{panel_link}}', 'myhome' ) . '<br><br>' . esc_html__( 'Regards,', 'myhome' ) . '<br>' . esc_html__( 'Administrator', 'myhome' ),
			...
			$section = array(
				...
				'desc'       => esc_html__( 'This field are available for Admin, Agent and Agency role. It will be not displayed for Buyer.', 'myhome' ),
				'id'         => 'myhome-agents',
				'subsection' => true,
				'fields'     => array(
					// phone
		...
		public function set_listing_options() {
			...
			if ( class_exists( '\MyHomeCore\Components\Listing\Search_Forms\Search_Form' ) ) {
				...
				$sort_by = array(
					...
					\MyHomeCore\Estates\Estate_Factory::ORDER_BY_PRICE_HIGH_TO_LOW => esc_html__( 'Price (high to low)', 'myhome' ),
					\MyHomeCore\Estates\Estate_Factory::ORDER_BY_PRICE_LOW_TO_HIGH => esc_html__( 'Price (low to high)', 'myhome' ),
					\MyHomeCore\Estates\Estate_Factory::ORDER_BY_POPULAR           => esc_html__( 'Popular', 'myhome' ),
					\MyHomeCore\Estates\Estate_Factory::ORDER_BY_TITLE_ASC         => esc_html__( 'Alphabetical order', 'myhome' ),
					\MyHomeCore\Estates\Estate_Factory::ORDER_BY_TITLE_DESC        => esc_html__( 'Reverse alphabetical order', 'myhome' ),
				);
			}
